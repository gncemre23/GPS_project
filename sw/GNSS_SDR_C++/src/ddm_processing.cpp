...
#define FUNC_PREFIX " Normal Acquisition (): "
  ...
  int samplesPerCode = round(settings->samplingFreq / (settings->codeFreqBasis / settings->codeLength));
  ...
  writeDoubleValueToMatFile(pmat, (double *)&samplesPerCode, 1, 1, false, "samplesPerCode");
